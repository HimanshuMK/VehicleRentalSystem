...
class List:
    def __init__(self,master):
        self.master = master
        self.master.title("Vehicle Rental System")
    ...
    def widget(self):
        ...
        self.head.pack()
        self.logf = Frame(self.master,padx =10,pady = 10,width=1350,height=500,highlightbackground="black", highlightthickness=6)
        Button(self.logf,text = ' List of Vehicle ',bd = 3 ,width="50" ,font = ('',15),padx=5,pady=5,command=self.LOV).grid()
        Button(self.logf,text = ' Return A Vehicle ',bd = 3 ,width="50" ,font = ('',15),padx=5,pady=5,command=self.RAV).grid()
        Button(self.logf,text = ' Logout ',bd = 3 ,width="50" ,font = ('',15),padx=5,pady=5,command=self.logout).grid()
    ...
    def LOV(self):
        ...
        self.logf.pack_forget()
        self.crof = Frame(self.master,padx =20,pady = 10,width=1350,height=500,highlightbackground="black", highlightthickness=6)
        Label(self.crof,text = 'Rent The Vehicle',font = ('',20),pady=5,padx=5).grid()
    
        Button(self.crof,text = ' Bike ',bd = 3,width="50" ,font = ('',15),padx=5,pady=5,command=self.Bike).grid()
        Button(self.crof,text = ' Car ',bd = 3 ,width="50" ,font = ('',15),padx=5,pady=5,command=self.Car).grid()
        Button(self.crof,text = ' Cycle ',bd = 3, width="50" ,font = ('',15),padx=5,pady=5,command=self.Cycle).grid()
        Button(self.crof,text = ' Scooter ',bd = 3 ,width="50" ,font = ('',15),padx=5,pady=5,command=self.Scooter).grid()
    ...
    def Bike(self):
        ...
        self.head.pack()
        self.logf = Frame(self.master,padx =10,pady = 10,width=1350,height=500,highlightbackground="black", highlightthickness=6)
        Button(self.logf,text = sh1.cell(2,2).value,bd = 3 ,width="50" ,font = ('',15),padx=5,pady=5,command=lambda:self.trv( sh1.cell(2,2).value)).grid(sticky=W)
        Button(self.logf,text = sh1.cell(3,2).value,bd = 3 ,width="50" ,font = ('',15),padx=5,pady=5,command=lambda :self.trv( sh1.cell(3,2).value)).grid(sticky=W)
        Button(self.logf,text = sh1.cell(4,2).value,bd = 3 ,width="50" ,font = ('',15),padx=5,pady=5,command=lambda: self.trv( sh1.cell(4,2).value)).grid(sticky=W)
        Button(self.logf,text = sh1.cell(5,2).value,bd = 3 ,width="50" ,font = ('',15),padx=5,pady=5,command=lambda: self.trv( sh1.cell(5,2).value)).grid(sticky=W)
        Button(self.logf,text = sh1.cell(6,2).value,bd = 3 ,width="50" ,font = ('',15),padx=5,pady=5,command=lambda: self.trv( sh1.cell(6,2).value)).grid(sticky=W)
        Button(self.logf,text = sh1.cell(7,2).value,bd = 3 ,width="50" ,font = ('',15),padx=5,pady=5,command=lambda: self.trv( sh1.cell(7,2).value)).grid(sticky=W)
        Button(self.logf,text = sh1.cell(8,2).value,bd = 3 ,width="50" ,font = ('',15),padx=5,pady=5,command=lambda: self.trv( sh1.cell(8,2).value)).grid(sticky=W)
        Button(self.logf,text = sh1.cell(9,2).value,bd = 3 ,width="50" ,font = ('',15),padx=5,pady=5,command=lambda: self.trv( sh1.cell(9,2).value)).grid(sticky=W)
        Button(self.logf,text = sh1.cell(10,2).value,bd = 3 ,width="50" ,font = ('',15),padx=5,pady=5,command=lambda: self.trv( sh1.cell(10,2).value)).grid(sticky=W)
        Button(self.logf,text = sh1.cell(11,2).value,bd = 3 ,width="50" ,font = ('',15),padx=5,pady=5,command=lambda: self.trv( sh1.cell(11,2).value)).grid(sticky=W)
    ...
    def Car(self):
        ...
        self.head.pack()
        self.logf = Frame(self.master,padx =10,pady = 10,width=1350,height=500,highlightbackground="black", highlightthickness=6)
        Button(self.logf,text = sh1.cell(2,2).value,bd = 3 ,width="50" ,font = ('',15),padx=5,pady=5,command=lambda :self.trv( sh1.cell(2,2).value)).grid()
        Button(self.logf,text = sh1.cell(3,2).value,bd = 3 ,width="50" ,font = ('',15),padx=5,pady=5,command=lambda :self.trv( sh1.cell(3,2).value)).grid()
        Button(self.logf,text = sh1.cell(4,2).value,bd = 3 ,width="50" ,font = ('',15),padx=5,pady=5,command=lambda: self.trv( sh1.cell(4,2).value)).grid()
        Button(self.logf,text = sh1.cell(5,2).value,bd = 3 ,width="50" ,font = ('',15),padx=5,pady=5,command=lambda: self.trv( sh1.cell(5,2).value)).grid()
        Button(self.logf,text = sh1.cell(6,2).value,bd = 3 ,width="50" ,font = ('',15),padx=5,pady=5,command=lambda: self.trv( sh1.cell(6,2).value)).grid()
        Button(self.logf,text = sh1.cell(7,2).value,bd = 3 ,width="50" ,font = ('',15),padx=5,pady=5,command=lambda: self.trv( sh1.cell(7,2).value)).grid()
        Button(self.logf,text = sh1.cell(8,2).value,bd = 3 ,width="50" ,font = ('',15),padx=5,pady=5,command=lambda: self.trv( sh1.cell(8,2).value)).grid()
        Button(self.logf,text = sh1.cell(9,2).value,bd = 3 ,width="50" ,font = ('',15),padx=5,pady=5,command=lambda: self.trv( sh1.cell(9,2).value)).grid()
        Button(self.logf,text = sh1.cell(10,2).value,bd = 3 ,width="50" ,font = ('',15),padx=5,pady=5,command=lambda: self.trv( sh1.cell(10,2).value)).grid()
        Button(self.logf,text = sh1.cell(11,2).value,bd = 3 ,width="50" ,font = ('',15),padx=5,pady=5,command=lambda: self.trv( sh1.cell(11,2).value)).grid()
        self.crof.pack_forget()
        self.logf.pack()
    def Cycle(self):
        self.head.pack_forget()
    ...
    def trv (self,Vehicle):
        ...
        for a in range (1,12):
            ...
            if self.vehicle ==self.s1.cell(a,2).value:
                if int(self.s1.cell(a,3).value)>0:
                    ...
                    Exit=ms.askyesno("Prompt","No vehicle Available Now,\n Choose Other one")
                    if Exit>0:
                        self.logf.pack_forget()
                        self.widget()        
    ...
    def RAV(self):
        self.head.pack_forget()
        self.logf.pack_forget()
        self.logf = Frame(self.master,padx =10,pady = 10,width=1350,height=500)
        self.number=StringVar()
    ...
    def checkSrNo(self, Number):
        ...
        for a in range (1,10):
            if self.number == str(self.s5.cell(a,11).value):
                ReturnVehicle(root, a)
                return
        else:
            #no Vehicles to return 
            n=ms.showerror("No Vehicles with this Serial Number Please Enter Correct One ")
            if n== "ok":
                self.RAV()
...
class ReturnVehicle:
    def __init__(self, root, main_row):
        ...
        def Receiptt():
            ...
            Total_bill = float(self.s5.cell(self.main_row,12).value)*(2000+500+Total_Reading*10) + float(Damage.get())
            ...
            self.txtReceipt2.insert(END, self.s5.cell(self.main_row,10).value + "\n")
            self.txtReceipt1.insert(END,'VehicleSerialNo: \n')
            self.txtReceipt2.insert(END, str(self.s5.cell(self.main_row,11).value) + "\n")
            self.txtReceipt1.insert(END,'Basic Charge: \n')
            self.txtReceipt2.insert(END, "2000 \n")
            self.txtReceipt1.insert(END,'Quantity: \n')
            self.txtReceipt2.insert(END, str(self.s5.cell(self.main_row,12).value)+"\n")
            ...
            n = str(self.s5.cell(self.main_row,11).value)
            for a in range (2,12):
                if str(self.s1.cell(a,1).value) == n[:6]:
                    new_quan=float(self.s1.cell(a,3).value)+float(self.s5.cell(self.main_row,12).value)
                    self.s1.cell(a,3).value = new_quan
                    wb.save("Vehicle.xlsx")
                if str(self.s2.cell(a,1).value) == n[:6]:
                    new_quan=float(self.s2.cell(a,3).value)+float(self.s5.cell(self.main_row,12).value)
                    self.s2.cell(a,3).value = new_quan
                    wb.save("Vehicle.xlsx")
                if str(self.s3.cell(a,1).value) == n[:6]:
                    new_quan=float(self.s3.cell(a,3).value)+float(self.s5.cell(self.main_row,12).value)
                    self.s3.cell(a,3).value = new_quan
                    wb.save("Vehicle.xlsx")
                if str(self.s4.cell(a,1).value) == n[:6]:
                    new_quan=float(self.s4.cell(a,3).value)+float(self.s5.cell(self.main_row,12).value)
                    self.s4.cell(a,3).value = new_quan
                    wb.save("Vehicle.xlsx")
    ...
    #===============================================recipt======================================================================
        Receipt_BottonFrame=LabelFrame(CustomerDetailsFrame,bd=10, width=500,height=400, relief=RIDGE)
        Receipt_BottonFrame.pack(side=RIGHT,fill=BOTH,expand=True)

        ReceiptFrame=LabelFrame(Receipt_BottonFrame, width=500,height=300, font=('arial',12,'bold'),text="Receipt", relief=RIDGE)
        ReceiptFrame.grid(row=0,column=0)

        ButtonFrame=LabelFrame(Receipt_BottonFrame, width=800,height=100, relief=RIDGE)
    ...
    #==================================================TravelFrame================================================================
        ...
        self.chkdamage=Label(TravelFrame,font=('arial',14,'bold'),text="Damage",bd=7)
        self.chkdamage.grid(row=5,column=0,sticky=W)
        self.txtdamage=Entry(TravelFrame,font=('arial',14,'bold'),textvariable=Damage,bd=7,insertwidth=2,justify=RIGHT)
    ...
    #======================================Button========================================================================================
        ...
        self.btnReceipt = Button(ButtonFrame,padx=18,bd=7,font=('arial',11,'bold'),width = 20,text='Receipt and Make Payment',command=Receiptt).grid(row=0,column=1)
        
        self.btnExit = Button(ButtonFrame,padx=18,bd=7,font=('arial',11,'bold'),width = 2,text='Exit', command=iExit).grid(row=0,column=4)
        
        self.btnExit = Button(ButtonFrame,padx=18,bd=7,font=('arial',11,'bold'),width = 2,text='Back', command=Back).grid(row=0,column=5)
...
class afterselectingVehicle():
    def __init__(self,root, Vehicle):
        ...
        for a in range (2,12):
            if self.s1.cell(a,2).value == self.Vehicle:
                self.serialNum  = str(self.s1.cell(a, 1).value)+str(self.s1.cell(a,3).value)
            if self.s2.cell(a,2).value == self.Vehicle:
                self.serialNum  = str(self.s2.cell(a, 1).value)+str(self.s2.cell(a,3).value)
            if self.s3.cell(a,2).value == self.Vehicle:
                self.serialNum  = str(self.s3.cell(a, 1).value)+str(self.s3.cell(a,3).value)
            if self.s4.cell(a,2).value == self.Vehicle:
                self.serialNum  = str(self.s4.cell(a, 1).value)+str(self.s4.cell(a,3).value)
        ...
        def Receiptt():
            ...
            if int(num.get()) == 0:
                # Exit= ms.showinfo("Quantity can't be zero")
                Exit= ms.showinfo(message="Quantity can't be zero")
                return
            
            if int(num.get())>int(self.serialNum[6:]):
                Exit= ms.askyesno("Prompt",f"Only {self.serialNum[6:]} available here, plz select different Vehicle")
                if Exit > 0:
                    # root.destroy()
                    Back()
                    return
            ...
            elif reset_counter == 0 and Firstname.get()!="" and Surname.get()!="" and Address.get()!="" and Postcode.get()!="" and Mobile.get()!="" and Telephone.get()!="" and Email.get()!="":
                self.txtReceipt1.delete("1.0",END)
                self.txtReceipt2.delete("1.0",END)
                ...
                self.txtReceipt1.insert(END, 'Quantity \n')
                self.txtReceipt2.insert(END, num.get()+'\n')
                ...
                s5.cell(maxrows+1, 5).value = Address.get()
                s5.cell(maxrows+1, 6).value = Postcode.get()
                s5.cell(maxrows+1, 7).value = Telephone.get()
                s5.cell(maxrows+1, 8).value = Mobile.get()
                s5.cell(maxrows+1, 9).value = Email.get()
                s5.cell(maxrows+1, 10).value = self.Vehicle
                s5.cell(maxrows+1, 11).value = self.serialNum
                s5.cell(maxrows+1, 12).value = num.get()
                wb.save("Vehicle.xlsx")

                for a in range (2,12):
                    if self.s1.cell(a,2).value == self.Vehicle:
                        self.s1.cell(a,3).value=float(self.s1.cell(a,3).value)-float(num.get())
                        wb.save("Vehicle.xlsx")
                    if self.s2.cell(a,2).value == self.Vehicle:
                        maxrows = self.s2.max_row
                        self.s2.cell(a,3).value=float(self.s2.cell(a,3).value)-float(num.get())
                        wb.save("Vehicle.xlsx")
                    if self.s3.cell(a,2).value == self.Vehicle:
                        maxrows = self.s3.max_row
                        self.s3.cell(a,3).value=float(self.s3.cell(a,3).value)-float(num.get())
                        wb.save("Vehicle.xlsx")
                    if self.s4.cell(a,2).value == self.Vehicle:
                        maxrows = self.s1.max_row
                        self.s4.cell(a,3).value=float(self.s4.cell(a,3).value)-float(num.get())
                        wb.save("Vehicle.xlsx")
    ...
    #===============================================recipt======================================================================
        ...
        ButtonFrame=LabelFrame(Receipt_BottonFrame, width=400,height=100, relief=RIDGE)
        ButtonFrame.grid(row=1,column=0)
    ...
    #=========================================================CustomerName====================================================
        ...
        self.qty=Label(CustomerName,font=('arial',14,'bold'),text="Quantity",bd=7)
        self.qty.grid(row=7,column=0,sticky=W)
        self.txtqty=Entry(CustomerName,font=('arial',14,'bold'),textvariable=num,bd=7,insertwidth=2,justify=RIGHT)
    ...
    #======================================Button========================================================================================
        ...
        self.btnback = Button(ButtonFrame,padx=18,bd=7,font=('arial',11,'bold'),width = 2,text='Back', command=Back).grid(row=0,column=4)
